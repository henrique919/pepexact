...
| 2026-07-17 | TASK-006 Link magnet | _pending merge_ | Chose `/guides/why-calculators-disagree` (measurement/rounding explainer) over the printable syringe chart. Article+Breadcrumb+FAQ schema; CTAs to peptide + syringe-units calculators; linked from homepage/footer/money page; sitemap. §5-clean. |
