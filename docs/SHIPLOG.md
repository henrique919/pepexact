...
| 2026-07-17 | TASK-V2-009 typed route registry | _pending_ | `routes.ts` single source of truth; shared `Breadcrumbs` + `RelatedTools`; sitemap/footer/CompoundLinks/compound template + all tool/guide/AU pages retrofit. Build: 21 static routes. |
