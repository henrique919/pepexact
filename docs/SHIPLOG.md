...
| 2026-07-17 | TASK-004B melanotan-2 + mots-c + aod-9604 | _pending merge_ | Human-directed added scope. melanotan-2 (α-MSH-analog identity, no tanning/efficacy), mots-c (mitochondrial-derived-peptide, minimal), aod-9604 (hGH-fragment, no fat-loss/efficacy). All PubMed-sourced, measurement-only, SSG, sitemap. |
