...
| 2026-07-17 | TASK-V2-011 printable syringe chart | 4d6ecc5 | `/guides/syringe-units-chart` — U-100 units→mL tables, print CSS, schema, §5-clean. Merged PR #14 → `0f581b7`; prod SSG confirmed (`X-Nextjs-Prerender: 1`, in sitemap). |
| 2026-07-17 | NEEDS HUMAN — TASK-V2-015 favicon/OG | — | Stop condition (asset design). Repo has no favicon/icon/OG image files; root layout OG is siteName+type only. Provide brand assets (or approve agent-generated SVG/PNG wordmark set) before V2-015 / V2-016 / V2-017 can continue. HV-1 still also blocks V2-006/007. |
