...
| 2026-07-17 | TASK-004 /calculator/tb-500 + /calculator/ghk-cu | _pending merge_ | Two data entries. tb-500: thymosin-beta-4-fragment identity, no stacks. ghk-cu: copper-tripeptide/cosmetic identity, route-neutral (no topical-vs-injectable advice). Both PubMed-sourced, measurement-only, SSG, sitemap. |
