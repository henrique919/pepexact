...
| 2026-07-17 | TASK-008 Money-page polish | _pending merge_ | Tool-first hero + text-only trust strip (no CLS/JS); stronger "Related tools & guides" closing block. Calculator + engine untouched, so shareable query URLs and math preserved; still SSG. Queue complete. |
