...
| 2026-07-17 | TASK-003 /calculator/bpc-157 | _pending merge_ | `bpc-157` data entry: synthetic-peptide identity + measurement notes, PubMed source pointer, no recovery/healing/protocol copy. SSG via shared `[slug]` route; sitemap via compoundRoutes. |
