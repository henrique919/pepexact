...
| 2026-07-17 | TASK-005 Homepage / nav IA | _pending merge_ | Shared `CompoundLinks` chip component; compound cluster on homepage + hub; footer "Compounds" column. Hub↔spoke internal linking complete. No card spam; header left minimal. |
