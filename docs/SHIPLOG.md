...
| 2026-07-17 | TASK-V2-008 patch | _pending merge_ | Fixed the homepage defect found above: `alternates.canonical` + Organization/WebSite JSON-LD (new helpers in `site.ts`). Closed v2-008's nav gap: header gains a "Compounds" link to a new `#compounds` anchor on the hub. |
